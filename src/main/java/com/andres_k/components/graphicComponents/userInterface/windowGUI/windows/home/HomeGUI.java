...
public class HomeGUI extends UserInterface {
    ...
    public void init() throws SlickException {
        // menu
        ComplexElement menu = new ComplexElement(ELocation.HOME_GUI_Menu.getId(), new ColorRect(new Rectangle(WindowConfig.get().centerPosX(EnumWindow.HOME, 320) - 5, WindowConfig.get().centerPosY(EnumWindow.HOME, 382) + 40, 320, 382)), true);
        ...
        buttonList.addItem(ElementFactory.createButtonTitleText("Practice", ColorTools.get(ColorTools.Colors.GUI_BLUE), EFont.MODERN, 25, EGuiElement.BUTTON_PLAY_SOLO, ElementFactory.createBasicButtonTasks(ELocation.HOME_GUI, ELocation.HOME_CONTROLLER, EnumWindow.GAME), ElementFactory.createImageFocusTasks()));
        ...
        //buttonList.addItem(ElementFactory.createButtonTitleText("Battle  ", ColorTools.get(ColorTools.Colors.GUI_YELLOW), EFont.MODERN, 25, EGuiElement.BUTTON_PLAY_MULTI, ElementFactory.createBasicButtonTasks(ELocation.HOME_GUI, ELocation.HOME_CONTROLLER, EnumWindow.SELECT_MULTI), ElementFactory.createImageFocusTasks()));
