...
public class SpectatorGodController {
    ...
    public void mouseReleased(int button, int x, int y) {
        if (button == 0 && this.clicked) {
            ...
            entities.stream().filter(entity -> entity.getType().isIn(new EGameObject[]{EGameObject.PORTAL_ATTRACT, EGameObject.PORTAL_REPULSE})).filter(entity -> entity.getBody().getFlippedBody(entity.getAnimatorController().getEyesDirection().isHorizontalFlip(), CameraController.get().getTransformPosX(entity.getPosX()),
